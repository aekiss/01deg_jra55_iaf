...
GDATADIR=/g/data3/hh5/tmp/cosima/access-om2-01/01deg_jra55v13_iaf_cice_blocks

mkdir -p ${GDATADIR}
cd archive
rsync --ignore-existing --exclude "*.nc.*" --exclude "*ocean_*_3hourly*" --exclude "*iceh_03h*" -vrltoD --safe-links output* ${GDATADIR}
